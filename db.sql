...
create table div_content (
cid int primary key auto_increment,
weiboid char(32),
wid char(10),
wtransid char(10),
cpart varchar(2000),/*分词*/
ccore varchar(2000),/*关键字*/
flag tinyint default 0,
inserttime timestamp default NOW()
)auto_increment=1;

create table div_tag(
...
create table div_remark(
rid int primary key auto_increment,
weiboid char(32),
wid char(10),
wtransid char(10),
rpart varchar(1000),/*分词*/
rcore varchar(1000),/*关键字*/
flag tinyint default 0,
inserttime timestamp default NOW()
)auto_increment=1;
...
/*修改表结构*/
alter table w_transfer add flag tinyint(1) default 0;
alter table w_content add flag tinyint(1) default 0;
select * from w_transfer;
